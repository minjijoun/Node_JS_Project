...
public class SoundProfileData : ScriptableObject
{
    ...
    public AudioClip GetRandomClip() => RandomClipList.Count > 0 ? RandomClipList.Randomltem() : null;
    public AudioClip GetCliplndex(int index) => RandomClipList.Count > index ? RandomClipList[index] : null;
}
